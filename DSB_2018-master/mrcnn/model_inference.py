...
ROOT_DIR = os.path.abspath("/home/srirampendyala/Projects/DSB_2018-master/")
...
class MaskRCNN():
    ...
    def __init__(self, mode, config, model_dir):
        ...
        self.keras_model._make_predict_function() #have to initialize before threading
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        list of num_instances masks: [height, width] Instance masks
        """
