        ...
        def analyze_image(self, image_name, norm_dendra_image, image_dir):
            ...
            with warnings.catch_warnings():
                ...
                if n_cells > 0:
                    ...
                    predictions = np.random.randint(3, size=n_cells)
                else:
                ...
                for i in range(n_cells):
                    if ((predictions[i] == 1) | (predictions[i] == 2)) & (cell_size[i] >= cell_size_cutoff) & (boundary_cell[i] == 0):
