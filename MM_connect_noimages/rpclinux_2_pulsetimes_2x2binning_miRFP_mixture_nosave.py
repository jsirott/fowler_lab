...
class LinuxService(rpyc.Service):
    class exposed_ImageAnalysis(object):
        ...
        def exposed_finalize(self):
            ...
            cell_dataframe = pd.DataFrame.from_dict(celldata,orient='index',columns=['ImageNumber', 'ImageDir', 'ObjectNumber', 'CellNumber', 'Size_X', 'Size_Y', 'Centroid_X', 'Centroid_Y', 'Cell_Size', 'Boundary_Cell', 'Mean_LMNA_intensity', 'Activated'])
        ...
        def exposed_run_pipeline_on_image(self, image_name, img):
            ...
            #normalize and save
            img_norm = self.normalize_image(img[:,:,1]) #only dendra channel (1), not LMNA channel (0)
        ...
        def analyze_image(self, image_name, norm_dendra_image, LMNA_image, image_dir):
            ...
            with warnings.catch_warnings():
                ...
                if n_cells > 0:
                    ...
                    predictions = mean_LMNA_intensity >= mean_LMNA_intensity_cutoff
                else:
                ...
                for i in range(n_cells):
                    ...
                    celldata[object_number] = [image_number, image_dir, object_number, i, cell_x_dim[i], cell_y_dim[i], cell_x_centroid[i], cell_y_centroid[i], cell_size[i], boundary_cell[i], mean_LMNA_intensity[i], predictions[i]]
                    object_number += 1
...
if __name__ == "__main__":
    ...
    output_dir = "./test/test_fixed_07_14_19"
